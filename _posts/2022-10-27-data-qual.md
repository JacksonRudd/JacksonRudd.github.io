...
Physics provides a useful analogy for data quality: 85% of the universe is constituted of dark matter -  that is, matter which does not interact with the electromagnetic spectrum and avoids detection. In much the same way, all datasets contain *dark issues*, data quality issues that cannot be directly observed. These issues are not just difficult to find, but actually undetectable.  
