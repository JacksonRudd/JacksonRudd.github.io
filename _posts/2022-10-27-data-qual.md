...
These are the statements I am interested in formalizing: 
...
**Exercise:** prove that $$a$$ is a deterministic alert (that $$a$$ only fires when there is a plausible data quality issue). 
