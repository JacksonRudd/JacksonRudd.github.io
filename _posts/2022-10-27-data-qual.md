...
Indeed we will prove in this post that dark issues exist in all non-trivial datasets as a result of a simple mathematical structure inherent to all data. 
