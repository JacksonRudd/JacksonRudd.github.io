...
> While data accuracy issues are detectable, data correctness is not. 

Physics provides a useful analogy for data accuracy: 85% of the universe consists of "dark matter" -  that is, matter which does not interact with the electromagnetic spectrum and avoids detection. 
