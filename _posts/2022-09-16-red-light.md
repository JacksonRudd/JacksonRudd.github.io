...
This post assumes no prior knowledge beside basic calculus and probability. We also mention the Holder's Inequality from analysis.

The basic situation described is familiar to anyone who drives. You are in a hurry, your cruising around 40 mph. You see the stoplight ahead turn red. You start to tap the brake, but you don't want to slow down too much. There is since there is a chance that if you control your speed correctly, you won't come to a full stop before the light turns green.
...
But how do you know how much to tap the break. Is there an optimal way to slow down? 
