...
In this blog post, we derive the optimal way to slow down for a red light using variational calculus. We derive all of the results from first principles, and rely on analogies and intuition to illuminate the key ideas of variational calculus. This post assumes no prior knowledge beside basic calculus, and we mention the Holder's Inequality from analysis.

The basic situation described is familiar to anyone who drives. You are in a hurry, your cruising at, say, 40 mph. You see the stoplight ahead turn red. You start to tap the brake, but you don't want to slow down too much since there is a chance that if you control your speed correctly, you won't come to a full stop before the light turns green. So how much should you tap on the brake?

Thanks for reading all and I hope you enjoy. Comments and suggestions welcome. 
